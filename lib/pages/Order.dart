...
class _OrderPageState extends State<OrderPage> {
  ...
  void _getListData() async {
    ...
    var api =
        '${Config.domain1}api/orderList?uid=${userinfo[0]['_id']}&sign=${sign}';
              ...
              return InkWell(
                ...
                child: Card(
                  child: Column(
                    children: <Widget>[
                      ListTile(
                        title: Text("Order Number：${value.sId}",
            ...
            child: Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text("To be paid", textAlign: TextAlign.center),
                  ),
                  Expanded(
